...
//        
//        //comentar post
//        fachada.comentarPost(new ComentarioDTO(fecha, "afasfasf", new ComentarioDTO(), new NormalDTO("madero@gmail.com", "Madero")), fachada.obtenerPostID(5L));

//        System.out.println(fachada.obtenerComentarioID(1L));
//        
//        //eliminar comentario
//        fachada.eliminarComentario(new ComentarioDTO(1L, fecha, "", new NormalDTO("", "")), usuarioBuscado);

            //eliminar post
//            fachada.eliminarPost(5L, usuarioBuscado);

            // comentar comentario
//            fachada.responderComentario(new ComentarioDTO(fecha, "asfasf", fachada.obtenerPostID(5L), new NormalDTO("madero@gmail.com", "Madero")), fachada.obtenerComentarioID(5L));
