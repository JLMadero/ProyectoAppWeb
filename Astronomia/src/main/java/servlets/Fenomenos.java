 ...
 * @author jl4ma
 */
public class Fenomenos extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("HOLA DESDE SERVLET FENOMENOS");
       IFachada accesoDatos = new Fachada();
        try {
            List<PostDTO> posts = accesoDatos.obtenerPostsPorCategoria(CategoriaPost.FENOMENOS);
            ...
            request.getRequestDispatcher("fenomenos.jsp").forward(request, response);
        } catch (FachadaException ex) {
            Logger.getLogger(Fenomenos.class.getName()).log(Level.SEVERE, null, ex);
