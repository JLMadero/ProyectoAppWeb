...
public class Planetas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       System.out.println("HOLA DESDE SERVLET PLANETAS");
       IFachada accesoDatos = new Fachada();
        try {
            List<PostDTO> posts = accesoDatos.obtenerPostsPorCategoria(CategoriaPost.PLANETAS);
            ...
            request.getRequestDispatcher("planetas.jsp").forward(request, response);
        } catch (FachadaException ex) {
            Logger.getLogger(Planetas.class.getName()).log(Level.SEVERE, null, ex);
